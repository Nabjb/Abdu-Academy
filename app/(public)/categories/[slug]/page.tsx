...
export default function CategoryPage() {
  ...
  useEffect(() => {
    fetchCourses();
  }, [filters, searchQuery, sortBy, categorySlug]);
  ...
  const hasActiveFilters = Boolean(filters.level || searchQuery || 
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        <Link href="/courses" className="inline-flex items-center gap-2 text-sm text-gray-600 hover:text-gray-900 mb-4">
          <ArrowLeft className="h-4 w-4" />
          Back to All Courses
        </Link>
        <h1 className="text-3xl font-bold mb-2">{categoryName} Courses</h1>
        <p className="text-gray-600">
          Discover {categoryName.toLowerCase()} courses to advance your skills
        </p>
      </div>
        ...
        <main className="flex-1">
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-600 mb-4">No courses found in this category</p>
              <Link href="/courses">
